...
void CarSumoClient::Read(InputMemoryBitStream& inInputStream)
{
	bool stateBit;
...
void CarSumoClient::DoClientSidePredictionAfterReplicationForLocalCat(uint32_t inReadState)
{
...
void CarSumoClient::InterpolateClientSidePrediction(float inOldRotation, const Vector3 & inOldLocation, const Vector3 & inOldVelocity, bool inIsForRemoteCat)
{
...
void CarSumoClient::DoClientSidePredictionAfterReplicationForRemoteCat(uint32_t inReadState)
{
	if ((inReadState & ECRS_Pose) != 0)
	{
