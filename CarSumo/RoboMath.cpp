...
#include "CarSumoPCH.hpp" // this part was changed by myself to fit my project. why am i being made to work with all rights reserved code? is it fine if i say it's an educational thing?
