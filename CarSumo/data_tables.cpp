...
std::vector<CarData> InitializeCarData()
{
	...
	data[static_cast<int>(CarType::kBasic)].m_texture_name = "kCars";
	...
	data[static_cast<int>(CarType::kJeep)].m_texture_name = "kCars";
	...
	data[static_cast<int>(CarType::kTruck)].m_texture_name = "kCars";
	...
	data[static_cast<int>(CarType::kMonster)].m_texture_name = "kCars";
