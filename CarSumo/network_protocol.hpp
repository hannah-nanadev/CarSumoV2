...
namespace Client
{
	enum class PacketType
	{
		kHello, //This is sent when the client connects to the server. No arguments.
		kPlayerInformation, //This is sent shortly after the client connects to the server. It sends the car type
