...
void CarSumo::ProcessInput(float inDeltaTime, const InputState& inInputState)
{
	//process our input....
...
void CarSumo::SimulateMovement(float inDeltaTime)
{
	//simulate us...
...
void CarSumo::ProcessCollisions()
{
...
void CarSumo::ProcessCollisionsWithScreenWalls()
{
...
uint32_t CarSumo::Write(OutputMemoryBitStream& inOutputStream, uint32_t inDirtyState) const
{
